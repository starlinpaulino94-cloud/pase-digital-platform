...
| **Automation Playbooks** | ✅ E1.1–E1.5 | `src/lib/automation/playbooks` — estrategias comerciales instalables (24 apartados del Documento Maestro) que envuelven automatizaciones reales de E1. E1.1: 20 captación (`ACQ-*`). E1.2: 18 onboarding (`ONB-*`). E1.3: 12 primera compra (`FP-*`). E1.4: 16 frecuencia (`FREQ-*`). E1.5: 16 recuperación (`REC-*`, framework de niveles de riesgo + gancho de IA). 82 playbooks universales y editables. Sin migración: reutiliza las tablas de E1. Próximas: E1.6–E1.10. |
